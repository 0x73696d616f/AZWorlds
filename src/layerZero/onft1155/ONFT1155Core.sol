...
abstract contract ONFT1155Core is NonblockingLzApp, ERC165, IONFT1155Core {
    ...
    function estimateSendFee(
        ...
        return estimateSendBatchFee(
            _dstChainId, _toAddress, _toSingletonArray(_tokenId), _toSingletonArray(_amount), _useZro, _adapterParams
        );
    }
    ...
    function sendBatchFrom(
        ...
        _sendBatch(
            _from, _dstChainId, _toAddress, _tokenIds, _amounts, _refundAddress, _zroPaymentAddress, _adapterParams
        );
    }
    ...
    function _nonblockingLzReceive(
        ...
        (bytes memory toAddressBytes, uint256[] memory tokenIds, uint256[] memory amounts) =
